...
//		robot.move(linRel(framePoints.get(0).getX(), 0.0, 0.0).setJointVelocityRel(0.5));
		...
		AbstractFrame abf = null;
		framePoints.get(0).copy(abf);
		pliers.getFrame("Sander").move(ptp(abf).setJointVelocityRel(0.5));
		//pliers.getFrame("Sander").move(ptp(getFrame("NP1")).setJointVelocityRel(0.5));
