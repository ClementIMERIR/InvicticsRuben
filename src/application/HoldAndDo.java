...
//		mode.parametrize(CartDOF.ALL).setStiffness(30);
	...
	private void registerPosition(){
		...
		//ObjectFrame newPointFrame2 = new ObjectFrame(toolVector.getX(), toolVector.getY(), toolVector.getZ());

		getLogger().info(String.valueOf(toolVector.getX()) + "|" + String.valueOf(toolVector.getY()) + "|" + String.valueOf(toolVector.getZ()));
