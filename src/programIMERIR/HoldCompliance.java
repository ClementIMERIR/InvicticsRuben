...
public class HoldCompliance extends RoboticsAPIApplication {
	...
	private ICallbackAction adjustZpos = new ICallbackAction() {
		...
		public void onTriggerFired(IFiredTriggerInfo triggerInformation) {
			...
			frame.setZ(penWorldAlign.getZ()+2);
	...
	public void initialize() {
		...
		penForceZneg = ForceCondition.createNormalForceCondition(penWorldAlign, CoordinateAxis.Z, 0);
