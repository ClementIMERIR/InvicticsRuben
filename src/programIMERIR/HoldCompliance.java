...
public class HoldCompliance extends RoboticsAPIApplication {
	...
	public void initialize() {
		...
		penCollision = ForceCondition.createSpatialForceCondition(penWorldAlign, 6);
		...
		penForceZpos = ForceCondition.createNormalForceCondition(penWorldAlign, CoordinateAxis.Z, 4);
		penForceZneg = ForceCondition.createNormalForceCondition(penWorldAlign, CoordinateAxis.Z, 1);
